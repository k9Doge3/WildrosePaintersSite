...
export const metadata: Metadata = {
  metadataBase: new URL("https://wildrosepainters.ca"),
  ...
  alternates: {
    ...
    languages: {
      "en-CA": "https://wildrosepainters.ca",
    },
  },
  other: {
    "geo.region": "CA-AB",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-7XTCYRXVKD"></script>
        <script
