...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-[#fffdf9] via-[#fbf6f1] to-[#f6efe7]">
      <Header />
      <ContactStrip />
      <main className="flex-1">
        <Hero />
        <section className="py-20 md:py-32 bg-white/70 backdrop-blur-md border-y border-black/5">
      ...
      <Footer />
      <script type="application/ld+json" suppressHydrationWarning dangerouslySetInnerHTML={{ __html: faqJsonLd }} />
    </div>
  )
}
