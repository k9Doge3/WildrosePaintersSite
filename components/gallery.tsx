...
export function Gallery() {
  return (
    <section id="gallery" className="py-20 md:py-32 bg-white/60">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="glass-card group relative aspect-[4/3] overflow-hidden border-primary/20 hover:glow-primary transition-all">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm text-muted-foreground">Edmonton Residential</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="glass-card group relative aspect-[4/3] overflow-hidden border-primary/20 hover:glow-primary transition-all">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm text-muted-foreground">Red Deer Project</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="glass-card group relative aspect-[4/3] overflow-hidden border-primary/20 hover:glow-primary transition-all">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm text-muted-foreground">Complete home transformation</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="glass-card group relative aspect-[4/3] overflow-hidden border-primary/20 hover:glow-primary transition-all">
            <Image
              ...
              unoptimized
            />
            <div className="absolute top-4 left-4 rounded-full bg-white/90 border border-black/5 px-4 py-2 text-sm font-semibold shadow-lg">
              Before
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <div className="absolute bottom-6 left-6 text-white">
                <p className="text-xl font-bold mb-1">Weathered Fence</p>
                <p className="text-sm text-muted-foreground">Before restoration</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="glass-card group relative aspect-[4/3] overflow-hidden border-primary/20 hover:glow-primary transition-all">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm text-muted-foreground">Flawless finish</p>
              </div>
            </div>
          </Card>
        </div>
