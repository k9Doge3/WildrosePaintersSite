...
export function InteractiveQuestionnaire() {
  ...
  if (isComplete) {
    return (
      <div className="flex min-h-[600px] flex-col items-center justify-center text-center animate-in fade-in duration-500">
    ...
    <div className="mx-auto w-full max-w-3xl">
      ...
      <Card className="border-2">
        <CardContent className="p-8">
          <div key={currentStep} className="animate-in fade-in slide-in-from-right-5 duration-300">
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`rounded-lg border-2 p-3 text-left transition-all hover:border-primary ${
                          formData.budget === option.value ? "border-primary bg-primary/5 font-medium" : "border-border"
                        }`}
                      >
                        {option.label}
                      </button>
