...
export function Footer() {
  return (
    <footer className="border-t border-black/5 bg-white/80 backdrop-blur-md">
      <div className="container py-12 md:py-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-black/5 bg-white transition-all hover:border-primary hover:bg-primary/10 hover:shadow-lg"
                aria-label="Facebook"
              >
        ...
        <div className="mt-12 border-t border-black/5 pt-8 text-center text-sm text-muted-foreground">
