                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Proper cleaning, sanding, priming, and repairs as needed</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="mt-1 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Quality workmanship backed by our satisfaction guarantee</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="rounded-lg border border-black/5 bg-white/80 p-6 text-center space-y-4">
